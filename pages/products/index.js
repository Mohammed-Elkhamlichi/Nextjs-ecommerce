...
const Products = ({ products }) => {
    return (
        <div
            className='flex flex-col  md:flex-row flex-wrap my-8'
            // style={{ background: "#541C94" }}
        >
            {products.map((product) => {
                const { id, title, description, image, price, category } =
                    product;
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className='flex flex-col items-center p-2'>
                                <div
                                    className='block before:content-["Category"] before:bg-yellow-800 before:text-white before:px-2 before:py-1 before:rounded before:opacity-40 font-mono text-md px-3 py-1 flex-1 text-center '
                                    style={{ color: "#440091" }}
                                >
                                    {title}
                                </div>
